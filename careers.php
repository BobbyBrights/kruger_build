...
<html>
  ...
  <div class="careers">
    ...
    <div class="careers__blocks">
      <div class="block" style="background-color:#fed02f">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">View Available Positions and Apply Online</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block wide" style="background-image:url(images/careers_1.jpg)">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Why Kruger Products?</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block" style="background-color:#d05658">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Not ready to apply? Join our Talent Network</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block wide" style="background-image:url(images/careers_2.jpg)">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Learn and Grow</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block wide tall" style="background-image:url(images/careers_3.jpg)">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Career Paths</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block" style="background-color:#52688e">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Make a Difference</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block tall" style="background-image:url(images/careers_4.jpg)">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Competitive Compensation</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block"  style="background-color:#bd7492">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Culture Matters</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
      </div>
      <div class="block" style="background-image:url(images/careers_5.jpg)">
        <a href="javascript:void(0)">
          <h4 class="vertical-align">Award Winning Company</h4>
          <svg class="icon">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#add-plus-button"></use>
          </svg>
        </a>
    ...
    <div class="text-block" style="display: none;">
      <div class="container">
        <h3>The right culture. <br>The right opportunities. <br>The right fit.</h3>
        <p class="col">If you’re looking for the complete package, consider a career with Kruger Products – recognized as a Top GTA Employer by The Globe and Mail for four consecutive years.</p>
        <p class="col">With eight facilities across North America and a head office in Mississauga, Ontario, we’re Canada’s leading manufacturer of premium consumer and commercial tissue products, and we’re always on the lookout for fresh talent.</p>
      </div>
    </div>
  </div>
