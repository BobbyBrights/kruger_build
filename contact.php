  ...
  <body>
    ...
    <div class="contact">
      ...
      <section class="contact__cf">
        <div class="container">
          <div class="pseudo-title">PLEASE COMPLETE THE FORM</div>
          <h4>General Inquiries and Feedback</h4>
          <form action="">
            <div class="form-wrap">
              <div class="col">
                <p>Note: Kruger Products L.P. does not accept or respond to submissions from persons under the age of thirteen. If you are under the age of thirteen, please have your parent or guardian submit an inquiry on your behalf. </p>
                <p>Regardless of how you contact us, please be assured that under no circumstances will the information you provide be shared or sold and will be used solely by Kruger Products L.P. and its affiliates. Please read our Privacy Policy for more details.</p>
              </div>
              <div class="col">
                <input type="text" name="title" placeholder="Title">
                <input type="text" name="name" placeholder="Name">
                <input type="text" name="last_name" placeholder="Last name">
                <input type="text" name="adress_1" placeholder="Adress 1">
                <input type="text" name="adress_2" placeholder="Adress 2">
              ...
              <div class="col">
                ...
                <input type="number" name="upc_code" placeholder="UPC Code" max="5">
              </div>
              <div class="clearfix"></div>
            </div>
          </form>
      ...
      <section class="contact__text">
        <div class="vertical-align">
          <div class="container">
            ...
            <h4>Whatever the reason, we look forward to hearing from you!</h4>
            <p>For general inquiries and feedback, the best way to reach us is by telephone. Please call <a href="tel:18889421212"><strong>1 888 942 1212</strong></a> toll-free Monday to Friday between 8:30 a.m. and 5:30 p.m. ET. If our office is closed, please leave a message and we will return your call promptly. Alternatively, you can complete our <a class="open-cf" href="javascript:void(0)">contact form</a>.</p>
          </div>
        </div>
      </section>
      <section class="contact__blocks">
        <div class="block" onclick="void(0)">
          <h4 class="vertical-align">Coupons and Promotions</h4>
          <div class="hover-block">
            <h4>Coupons and Promotions</h4>
            <p>While we are committed to social responsibility and would like to be able to respond to every request we receive, we believe we can be more effective by supporting specific initiatives in our communities. To this end, we are proud to be a top five national contributor to the Canadian Breast Cancer Foundation (CBCF), a national charitable organization dedicated to creating a future without breast cancer. To learn more about CBCF and other organizations we support, please visit our Community page.</p>
          </div>
        </div>
        <div class="block" onclick="void(0)">
          <h4 class="vertical-align">Donations</h4>
          <div class="hover-block">
            <h4>Donations</h4>
            <p>While we are committed to social responsibility and would like to be able to respond to every request we receive, we believe we can be more effective by supporting specific initiatives in our communities. To this end, we are proud to be a top five national contributor to the Canadian Breast Cancer Foundation (CBCF), a national charitable organization dedicated to creating a future without breast cancer. To learn more about CBCF and other organizations we support, please visit our Community page.</p>
          </div>
        ...
        <div class="block" onclick="void(0)">
          <h4 class="vertical-align">Commercial Products</h4>
          <div class="hover-block">
        ...
        <div class="block" onclick="void(0)">
          <h4 class="vertical-align">Send Us a Letter</h4>
          <div class="hover-block">
        ...
        <div class="block" onclick="void(0)">
          <h4 class="vertical-align">School Projects</h4>
          <div class="hover-block">
        ...
        <div class="block" onclick="void(0)">
          <h4 class="vertical-align">Retailers and Distributors</h4>
          <div class="hover-block">
            <h4>Retailers and Distributors</h4>
            <p>While we are committed to social responsibility and would like to be able to respond to every request we receive, we believe we can be more effective by supporting specific initiatives in our communities. To this end, we are proud to be a top five national contributor to the Canadian Breast Cancer Foundation (CBCF), a national charitable organization dedicated to creating a future without breast cancer. To learn more about CBCF and other organizations we support, please visit our Community page.</p>
          </div>
        </div>
        <div class="clearfix"></div>
